function[distances] = example1(surf, source, stopPts)
...
tic
vertex_id = source;                             %create a single source at vertex #1
...
geodesic_propagate(algorithm, source_points, stop_points, 250);   %propagation stage of the algorithm (the most time-consuming)
